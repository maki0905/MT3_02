...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	while (Novice::ProcessMessage() == 0) {
		...
		SMatrixScreenPrintf(kColumnWidth * 5, 0, transposeM1, "transposeM1");
		SMatrixScreenPrintf(kColumnWidth * 5, kRowHeight * 5, transposeM2, "transposeM2");
		SMatrixScreenPrintf(kColumnWidth * 5, kRowHeight * 5 * 2, identity, "identity");
		///
		/// ↑描画処理ここまで
		///
